...
public class defaultLists {
    ...
    public static void defaultQuestionsAndActions() { //TODO добавить правду и действия для всех листов
        ...
        normalActionWoman.add("Поставь засос на шее любому из игроков. Засос должен быть виден :)");
        ...
        normalActionMan.add("Поставь засос на шее любому из игроков. Засос должен быть виден :)");
        normalActionMan.add("Трогай за грудь и целуй игрока женского пола напротив тебя в течени 2 минут");
        ...
        hardActionMan.add("Как долго можешь не кончать? Продемонстрируй это на любом игроке женского пола. Не забудь" +
                " засечь время ;)");


        //Игра Я Никогда Не
        iNever.add("Я никогда не прыгал с парашютом");
        iNever.add("Я никогда не летал на самолете");
        iNever.add("Я никогда не занимался сексом в душе");
        iNever.add("Я никогда не уводил парня/девушку своего знакомого/друга");
        iNever.add("Я никогда не был на нудистском пляже");
        iNever.add("Я никогда не писал своих песен");
        iNever.add("Я никогда не писал своих стихов");
        iNever.add("Я никогда не рисовал картины");
